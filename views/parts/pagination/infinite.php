...
/**
 * Fires before displaying infinite pagination.
 *
 * @param  array   $_pagination
 */
do_action('ol.apollon.pagination_part_infinite_before', $_pagination);
...
/**
 * Fires after displaying infinite pagination.
 *
 * @param  array   $_pagination
 */
do_action('ol.apollon.pagination_part_infinite_after', $_pagination);
