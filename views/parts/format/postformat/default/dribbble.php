...
$_format_item['html'] = [
    ...
    'thumbnail' => empty($_format_item['images']) ? '' : sprintf(
        __('<figure class="%s">%s</figure>', OL_APOLLON_DICTIONARY),
...
$_format_item['html'] = apply_filters(
    'ol.apollon.format_post_default_dribbble_html',
    $_format_item['html'],
    $_format_item
);
 ...
 * @return string
 */
$_format_item['html']['thumbnail'] = apply_filters(
    'ol.apollon.format_post_default_dribbble_thumbnail',
