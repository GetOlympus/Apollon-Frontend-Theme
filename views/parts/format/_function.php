 ...
 * @return array
 */
add_filter('ol.apollon.format_build_data', function ($data = []) {
    // Build defaults data
    $data = array_merge([
        'id'         => get_the_ID(),
    ...
    /**
     * Check whether post format to display.
     *
     * @param  string
     *
     * @return string
     */
    $data['display'] = apply_filters('ol.apollon.format_post_display', 'default');
