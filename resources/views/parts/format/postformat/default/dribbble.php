...
/**
 * Format post default display dribbble subpart.
 * 
...
$_format_item['html'] = [
    'attrs' => sprintf(
        ...
        sprintf(
            ...
            empty($_format_item['images']) ? '' : 'ap-f-dribbble uk-grid'
        ),
    ...
    'thumbnail' => empty($_format_item['images']) ? '' : sprintf(
        ...
        'uk-width-1-2@m uk-flex-first uk-padding-small uk-image uk-first-column',
    ...
    'opentag'  => empty($_format_item['images']) ? '' : '<div class="uk-width-expand uk-article uk-padding-small">',
...
/**
 * Override format post default dribbble html.
 *
 * @param  array   $html
 ...
 * @return array
 */
$_format_item['html'] = apply_filters('ol.apollon.format_post_default_dribbble_html', $_format_item['html'], $_format_item);


/**
 * Override format post default dribbble order.
 *
 * @param  array   $order
 *
 * @return array
 */
$_format_item['html']['_order'] = apply_filters('ol.apollon.format_post_default_dribbble_order', [
...
/**
 * Override format post default dribbble thumbnail.
 *
 * @param  string  $thumbnail
 *
 * @return string
 */
$_format_item['html']['thumbnail'] = apply_filters('ol.apollon.format_post_default_dribbble_thumbnail',
    $_format_item['html']['thumbnail']
);


/**
 * Override format post default dribbble content.
 *
 * @param  string  $html
 ...
 * @return string
 */
echo apply_filters('ol.apollon.format_post_default_dribbble_content', sprintf(
    '<a %s>%s%s%s%s</a>',
 ...
 * @return string
 */
echo apply_filters('ol.apollon.build_separator', '', 'default-dribbble');
